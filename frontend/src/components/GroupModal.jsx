...
export default function GroupModal({ onClose }) {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-md bg-white rounded-2xl shadow-2xl border border-indigo-100 flex flex-col"
      ...
      >
        ...
        <form onSubmit={handleCreate} className="flex flex-col flex-1 min-h-0">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-4">
            ...
            {/* Selected member chips — scrollable area, max 3 rows */}
            {selectedMembers.length > 0 && (
              <div>
                <p className="text-xs text-slate-500 font-semibold mb-1.5">{selectedMembers.length} member{selectedMembers.length !== 1 ? 's' : ''} selected</p>
          ...
          {/* Submit button — always pinned at the bottom */}
